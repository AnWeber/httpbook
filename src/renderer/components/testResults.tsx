...
const TestResultStatusIcon: FunctionComponent<{ status: TestResultStatus }> = ({ status }) => {
  if (status === 'SUCCESS') {
    return (
      <svg
        class="testicon testicon--success"
        viewBox="0 0 16 16"
  ...
  if (status === 'SKIPPED') {
    return (
      <svg
        class="testicon testicon--skipped"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 16 16"
        fill="currentColor"
      >
  ...
  return (
    <svg class="testicon testicon--error" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
